      ...
      <div className="under-nav">
        ...
        <div className="team-container">
          ...
          <div className="members-wrapper">
            {(project.team[user.id].admin || project.team[user.id].owner) && (
              <OpenModalButton
                className="add-team-member"
                modalComponent={<AddTeamMemberModal projectId={projectId} />}
                buttonText={
                  <>
                    <i className="fa-solid fa-plus team"></i> Add Member
                  </>
                }
              />
            )}
            {Object.values(project.team).length &&
              Object.values(project.team)
                .sort((a, b) => {
                  if (a.owner) return -1;
                    ...
                    >
                      {member.user.imageUrl ? (
                        <div className="profile-button">
                          <img src={member.user.imageUrl}></img>
                        </div>
                      ) : (
                        <div className="profile-button">
                      ...
                      {showMenu &&
                        ...
                        !roleInput && (
                          ...
                          >
                            ...
                            >
                              <li
                                className="member-menu-li"
                                style={{
                                  borderBottom:
                                    "hsla(0, 0%, 100%, 0.259) 0.01rem solid",
                                }}
                                onClick={() => {
                              ...
                              {!member.owner && (
                                <li
                                  ...
                                  onClick={() => {
                                    dispatch(memberAdminPut(member.id)).then(
                                      (data) => {
                                        if (data) {
                        ...
                        >
                          ...
                          >
                            ...
                            <form className="role-form">
                              ...
                              />
                              <button
                                onClick={roleSubmit(member.role)}
                            ...
                            {errorRole ? (
                              <p className="errors">* {errorRole}</p>
                            ) : null}
                          </div>
                        </DropDownMenu>
                      )}
            ...
            {Object.values(project.resources).length ? (
              <>
                <OpenModalButton
                  ...
                  buttonText={<i className="fa-solid fa-plus resource"></i>}
                  modalComponent={<CreateResourceModal projectId={projectId} />}
                />
                {Object.values(project.resources).map((resource) => {
                  ...
                  return (
                    <div key={resource.id} className="resource-container">
                      ...
                      <i
                        title="Delete Reosurce"
                        className="fa-solid fa-trash-can delete-resource"
                        onClick={(e) => {
              ...
              <div className="no-resources">
                ...
                <div className="explain-resources">
                  <p>
                    Add links to supporting resources for your project such as
                    the github repo or wireframes.
                  </p>
                  <OpenModalButton
                    className="add-first-resource"
                    buttonText={
                      <>
                        <i className="fa-solid fa-link"></i> Add links here!
                      </>
                    }
                    modalComponent={
                      <CreateResourceModal projectId={projectId} />
                    }
                  />
                </div>
              </div>

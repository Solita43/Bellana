...
def seed_cards():
    cards=[
        ...
        Card(category="backlog", board_id=4, order=0),
        Card(category="in Progress", board_id=4, order=1),
        Card(category="in Review", board_id=4, order=2),
        Card(category="Deployed", board_id=4, order=3),
        ]

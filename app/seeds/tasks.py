...
def seed_tasks():
    ...
    tasks_backlog_board_1 = [Task(details='User authentication feature', user_id=2),
                             Task(details='API integration with third-party service', user_id=2),
                             Task(details='Allow user to add and update profile picture', user_id=2)]
    ...
    tasks_inprogress_board_1 = [Task(details='Refactoring database structure', user_id=2),
                             Task(details='Implementing payment gateway', user_id=2)]
    ...
    tasks_inreview_board_1 = [Task(details='Test cases for new feature', user_id=2),
                             Task(details='Cross-browser compatibility testing', user_id=2)]
    ...
    tasks_deployed_board_1 = [Task(details='Release version 1.0', user_id=2),
                             Task(details='Documentation updates', user_id=2)]
    ...
    tasks_strategy_board_2 = [Task(details='Define target audience', user_id=2),
                             Task(details='Set campaign goals', user_id=2)]
    ...
    tasks_content_creation_board_2 = [Task(details='Write blog posts', user_id=2),
                                      Task(details='Create social media content', user_id=2),
                                      Task(details='Design banner ads', user_id=2),
                                      Task(details='Create landing page visuals', user_id=2)]
    ...
    tasks_promotion_board_2 = [Task(details='Schedule social media posts', user_id=2),
                               Task(details='Launch email marketing campaign', user_id=2)]
    ...
    tasks_done_board_2 = [Task(details='Evaluate campaign performance', user_id=2),
                          Task(details='Generate campaign report', user_id=2)]
